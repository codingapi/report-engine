...
public class Report {
     ...
     * <p>循环块的迭代值不是参数，通过 {@link com.example.report.model.param.ValueRef.LoopField} 直接引用。
     */
     ...
     * <ul>
     *   <li>{@link com.example.report.model.grid.TextCell} — 文本 + 参数占位（如"${year}年度报表"）</li>
     *   <li>{@link com.example.report.model.grid.FieldCell} — 数据字段绑定 + 扩展 + 分组 + 条件</li>
     * </ul>
     ...
     * 每个循环块绑定一个 {@link com.example.report.model.source.Query}（数据集 + 过滤 + 分组），
     * 决定迭代的范围和顺序。块内格子可通过 {@link com.example.report.model.param.ValueRef.LoopField}
     * 引用当前迭代行的字段。
     */
