 ...
 *   <li>{@link #join(RawTable, RawTable, com.example.report.model.source.Relationship)} — 关联：
...
public final class Operators {
     ...
     * <p>每个条件通过 {@link ParamContext#resolve(com.example.report.model.param.ValueRef)}
    ...
    /**
     * 内连接（hash join）：按 {@link com.example.report.model.source.Relationship} 定义的
