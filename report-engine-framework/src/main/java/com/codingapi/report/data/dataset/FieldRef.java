 ...
 *   <li>{@link com.codingapi.report.data.relation.Relationship} — 跨数据集关联的左右端点</li>
 * </ul>
 *
 ...
 *
 * <h3>为什么不存别名？</h3>
 * <p>别名（{@link com.codingapi.report.data.dataset.Field#getAlias()}）是面向用户的展示名，
...
public record FieldRef(String datasetId, String field) {
     ...
     * <p>例：{@code FieldRef("employees", "name")} → {@code "employees.name"}。
     * 多数据集 join 后用限定名避免同名字段冲突。
     */
