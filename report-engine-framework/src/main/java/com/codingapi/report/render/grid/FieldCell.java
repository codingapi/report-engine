 ...
 * 子格是"员工名"来自 emp 表），渲染引擎通过 {@link com.codingapi.report.data.relation.Relationship}
 ...
 *
 * @see com.codingapi.report.data.dataset.FieldRef
 * @see Expansion
 * @see ExpandMode
 */
@Data
...
public final class FieldCell implements CellBinding {
    ...
    /**
     * 该格子上的过滤条件列表。
     * <p>条件右值可以是字面量、报表参数或循环字段（{@link com.codingapi.report.param.ValueRef}），
     * 使过滤逻辑能动态响应运行时参数和循环上下文。
     * <p>与 {@link com.codingapi.report.data.dataset.Query#getFilters()} 的区别：
