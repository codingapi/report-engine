 ...
 * <h3>扩展方式</h3>
 *
 * <p>新增一个比较算子（如 REGEX/BETWEEN）：实现 {@link ConditionPredicate}， 在 {@link #REGISTRY} 列表里登记一行即可，无需改动
 * {@code Operators} 或任何调用方。
 *
 * <h3>与旧实现的区别</h3>
 *
...
public final class ConditionPredicates {
    ...
    /** 内置算子实现。新增算子在此登记。 */
    private static final List<ConditionPredicate> REGISTRY =
            List.of(
                    new EqPredicate(),
                    new NePredicate(),
                    new GtPredicate(),
