 ...
 * <p>条件右值不是只能填固定值——通过 {@link com.codingapi.report.param.ValueRef}
 * 密封接口，支持三种来源：
 * <pre>
 *   1. 字面量（Literal）：
...
public class Condition {
    ...
    /**
     * 右值：字面量、参数引用或循环字段引用。
     * <p>通过 {@link com.codingapi.report.param.ValueRef} 密封接口的三种实现，
     * 让过滤条件能静态配置、动态参数化、循环上下文感知。
     * <p>IS_NULL/IS_NOT_NULL 算子时可为 null。
     */
    private com.codingapi.report.param.ValueRef value;
}
