 ...
 *
 * <h3>支持哪些表达式是预先约定的</h3>
 * <p>{@link Value} 是密封类型，节点集合封闭；每种节点的求值由 {@link #EVALUATORS} 里登记的策略提供。
 * 求值递归（如 {@code Template} 的洞、{@code Aggregate} 的子表达式）通过把引擎自身回传给策略实现。
 *
...
public final class ExpressionEngine {
    ...
    private static final List<ValueEvaluator> EVALUATORS = List.of(
