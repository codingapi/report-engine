 ...
 * 无需预先在 {@link com.codingapi.report.model.Report#getParameters()} 里登记。
 ...
 *
 * <h3>与 JOIN 的关系</h3>
 * <p>循环是"关联两个表"的<b>第二种方式</b>（相对于 {@link com.codingapi.report.model.source.Relationship} 的静态 JOIN）：
 * <ul>
