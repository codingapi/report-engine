 ...
 * <p>
 * 涵盖字体、对齐、自动换行、文字旋转、背景填充、四边边框、数字格式和内边距。
 * 可直接映射到 Apache POI 的 CellStyle 和 Font API。
 * </p>
 */
@Data
public class Style {
    ...
    /**
     * 水平对齐方式。
     * 可选值：left / center / right / justify / distributed
     */
    ...
    /**
     * 数字格式字符串，遵循 Excel 格式规范。
     * 例如："0.00"（两位小数）、"#,##0"（千位分隔）、"yyyy-MM-dd"（日期）
     */
