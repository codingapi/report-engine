...
describe('extractSnapshot', () => {
    ...
    test('loopBlocks 按 sheetId 过滤并挂载 loopBlockProps', () => {
        const blocks: LoopBlockConfig[] = [
            { id: 'b1', sheetId: 's1', startRow: 0, startColumn: 0, endRow: 2, endColumn: 1, label: 'L1' },
        ...
        expect(s1.loopBlocks).toEqual([
            expect.objectContaining({ id: 'b1', startRow: 0, startCol: 0, endRow: 2, endCol: 1, props: [{ kind: 'loopProp' }] }),
        ]);
