...
describe('styleToCss', () => {
    ...
    test('字体全属性映射(size 为 pt)', () => {
        const css = styleToCss({
            font: { family: 'Arial', size: 14, bold: true, italic: true, underline: true, strikethrough: true, color: '#ff0000' },
        });
        expect(css).toEqual({
            fontFamily: 'Arial', fontSize: '14pt', fontWeight: 'bold', fontStyle: 'italic',
            textDecoration: 'underline line-through', color: '#ff0000',
